...
*   **Context Window (上下文窗口)**: 模型一次能“看见”的最大 Token 数量（如 Claude Opus 4.7/4.6 和 Sonnet 4.6 的 1M，或 Haiku 4.5/Sonnet 4.5 的 200K）。包含 Input + Output。
...
*   **Opus**: Claude 模型家族中最强大的系列，擅长复杂推理与高难度工程任务。当前最新为 Claude Opus 4.8（2026-05 发布，上一代为 Opus 4.7）。
