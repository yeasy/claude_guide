...
| 厂商 | 模型系列 | 当前最新版本 | 发布时间 |
|-----|--------|-----------|--------|
| Anthropic | Claude | 4.6 | 2025-05 |
| OpenAI | GPT-4 | GPT-4 Turbo (gpt-4-turbo) | 2024-04 |
| Google | Gemini | 2.5 Pro | 2025-02 |
| Meta | Llama | 3.1 | 2024-07 |
| Mistral | Mistral | 8x22B | 2024-09 |
| xAI | Grok | 3 | 2025-01 |
...
| 维度 | Claude Haiku | Claude Sonnet | Claude Opus 4.6 | GPT-4 Turbo | Gemini 2.5 Pro | DeepSeek-V3 |
|-----|-------------|--------------|-----------------|-------------|---------------|------------|
| **定价（输入/输出）** | $0.80/$4.00 | $3.00/$15.00 | $5.00/$25.00 | $10.00/$30.00 | $1.50/$6.00 | $0.27/$1.10 |
| **上下文长度** | 200K token | 200K token | 200K token | 128K token | 1M token | 64K token |
| **推理延迟** | ~100ms | ~300-400ms | ~1-2s | ~200-400ms | ~150-300ms | ~200-300ms |
| **性价比指数** | 10.0 | 8.5 | 6.0 | 3.5 | 9.0 | 11.0 |
| **推理能力(MATH)** | 71% | 89% | 95% | 86% | 87% | 90% |
| **编程能力(HE)** | 77% | 92% | 96% | 90% | 91% | 88% |
| **常识理解(MMLU)** | 82% | 95% | 98% | 94% | 95% | 92% |
...
| 基准 | Claude 4.6 | GPT-4 Turbo | Gemini 2.5 Pro | 说明 |
|-----|-----------|-----------|--------------|-----|
| MATH | 89.2% | 86.4% | 87.5% | 数学问题求解 |
| MMLU | 95.1% | 94.1% | 94.8% | 多任务知识理解 |
| HumanEval | 92.3% | 90.2% | 91.5% | 编程能力 |
| ARC-Challenge | 94.2% | 92.8% | 93.5% | 科学推理 |
| HellaSwag | 96.1% | 95.3% | 95.8% | 常识推理 |
...
| 编程语言 | Claude 4.6 | GPT-4 Turbo | Gemini 2.5 |
|---------|-----------|-----------|-----------|
| Python | 95% | 92% | 90% |
| JavaScript/TypeScript | 94% | 93% | 91% |
| Java | 91% | 89% | 87% |
| C++ | 88% | 86% | 84% |
| Rust | 85% | 82% | 79% |
| Go | 87% | 85% | 83% |
...
| 特性 | Claude 4.6 | GPT-4 Turbo | Gemini 2.5 |
|-----|-----------|-----------|-----------|
| 正确性 | 92% | 88% | 85% |
| 可运行性 | 95% | 91% | 87% |
| 最佳实践 | 89% | 86% | 82% |
...
| 能力 | Claude 4.6 | GPT-4o | Gemini 2.5 Pro |
|-----|-----------|--------|---------------|
| 物体识别 | 96% | 95% | 94% |
| 文字识别 (OCR) | 94% | 93% | 92% |
| 图表理解 | 91% | 89% | 87% |
...
| 维度 | Claude 4.6 | GPT-4 Turbo | Gemini 2.5 Pro |
|-----|-----------|-----------|--------------|
| 知识截止日期 | 2024-12 | 2024-04 | 2025-01 |
| 实时网络搜索 | 通过工具 | 通过插件 | 原生支持 |
| 幻觉率 | 1.3% | 1.8% | 1.6% |
| 事实准确率 | 94.7% | 93.2% | 93.8% |
...
| 攻击类型 | Claude 4.6 防御 | GPT-4 防御 | Gemini 2.5 防御 |
|---------|---------------|-----------|--------------|
| 越狱提示 | 很强 | 强 | 强 |
| 有害内容生成 | 拒绝率 98% | 97% | 96% |
| 隐私敏感信息 | 很强 | 强 | 强 |
...
| 模型 | 输入成本 | 输出成本 | 缓存成本 | 相对成本 |
|-----|--------|--------|--------|--------|
| Claude Haiku | $0.80/M | $4/M | $0.24/M | 最低 |
| Claude Sonnet | $3/M | $15/M | $0.90/M | 低 |
| GPT-4 Turbo | $10/M | $30/M | N/A | 中-高 |
| Claude Opus 4.6 | $5/M | $25/M | $1.5/M | 中 |
| Gemini 2.5 Pro | $1.5/M | $6/M | N/A | 低 |
| GPT-4o | $5/M | $15/M | N/A | 中 |
...
|-----|--------|----------------|--------|
| Haiku | $0.0013 | $1.30 | 最低 |
| Sonnet | $0.0030 | $3.00 | 低 |
| Gemini 2.5 Pro | $0.0015 | $1.50 | 最低 |
| GPT-4o | $0.0070 | $7.00 | 低-中 |
| GPT-4 Turbo | $0.0160 | $16.00 | 中-高 |
| Opus 4.6 | $0.0075 | $7.50 | 中 |

**容量和速率限制**

| 限制 | Claude | GPT-4 | Gemini 2.5 |
|-----|--------|--------|-----------|
| 并发请求数 | 10K+ | 3-10K | 10K+ |
| 每分钟请求数 | 无限制* | 100-500* | 1000 |
...
需求 1: 推理复杂度
  ...
  │  └─ Claude Opus 4.6 ✓
  ├─ 高 (数据分析、架构设计)
  │  └─ Claude Sonnet 或 GPT-4 Turbo
  └─ 中等及以下
     └─ Claude Haiku 或 Gemini 2.5 Pro
...
推荐：**Gemini 2.5 Pro** 或 **GPT-4o**

```python
# Gemini 2.5 Pro（更好的视频支持）
import anthropic
...
推荐：**Claude 4.6** 或 **GPT-4 Turbo**

| 对比维度 | Claude 4.6 | GPT-4 Turbo |
|---------|-----------|-----------|
| 数学推理 | 89.2% | 86.4% |
| 论文理解 | 优秀 | 优秀 |
| 知识截止 | 2024-12 | 2024-04 |
| 幻觉率 | 1.3% | 1.8% |
...
def ab_test_models(query: str, traffic_split: float = 0.5) -> dict:
    ...
    if random.random() < traffic_split:
        ...
        return {"model": "gpt4", "response": response}
```
...
```
当前成本（GPT-4 Turbo）:
  输入: 1000 万 × 500 token × $10/M = $50,000
  输出: 1000 万 × 200 token × $30/M = $60,000
  总计: $110,000/月
...
graph TD
    A["模型选择决策树"]
    B["需要多模态吗?"]
    B1["必须支持视频<br/>→ Gemini 2.5 Pro"]
    B2["只需图像<br/>→ Claude 4.6 或 GPT-4o"]
    B3["不需要<br/>→ 继续"]

    C["延迟要求是什么?"]
    C1["<200ms<br/>→ Claude Haiku"]
    C2["<500ms<br/>→ Claude Sonnet"]
    C3[">1s<br/>→ Claude Opus 4.6"]
...
graph TD
    ...
    B["性能等级 98: Claude Opus 4.6<br/>(最高性能，高成本)"]
    C["性能等级 95: Sonnet 4.6, GPT-5, Gemini 2.5 Pro<br/>(Pareto 前沿)"]
    D["性能等级 90: Haiku 4.5, Gemini 2.5 Flash"]
...
| **Gemini 2.5 Flash** | $1.50 | 83 | 轻量应用、多模态 | 便宜高性能 |
| **Claude Sonnet 4.6**| $3.00 | 92 |**通用推荐** | 中心（最佳平衡） |
| **Claude Opus 4.6** | $5.00 | 98 | 超高精度、研究级 | 右上角（最高性能） |
...
Opus 4.6:     ($5 × 500 + $25 × 200) / 1M = $0.0075
GPT-5:        ($8 × 500 + $30 × 200) / 1M = $0.0100
Gemini 2.5:   ($1.5 × 500 + $6 × 200) / 1M = $0.0018
```
...
Opus 4.6:
  基础成本: 1000 × $0.0225 = $22.50
  批处理折扣: $22.50 × 0.5 = $11.25
```
...
graph TD
    ...
    D["预算 $1000-$5000/月"]
    D1["优先级: 性能 > 成本"]
    D2["推荐: Sonnet 4.6 + 少量 Opus 4.6"]
    D3["用途: 混合工作流"]
    D4["吞吐: 5K-20K 请求/月"]

    E["预算 > $5000/月"]
    E1["优先级: 性能 >> 成本"]
    E2["推荐: Claude Opus 4.6"]
    E3["用途: 研究、金融分析、医学诊断"]
    E4["吞吐: <5K 请求/月"]
...
```
Claude Sonnet ($3/M, 92%)：
├─ vs Haiku: Sonnet 更贵但性能更强 → 都在前沿上 ✓
├─ vs Opus: Sonnet 更便宜但性能更弱 → 都在前沿上 ✓
├─ vs GPT-4 Turbo ($10/M, 86%): Sonnet 更便宜且性能更强 → Turbo 被击败 ✗
└─ vs Gemini 2.5 Pro ($1.5/M, 87%): Sonnet 性能更强但更贵 → 都在前沿上 ✓
