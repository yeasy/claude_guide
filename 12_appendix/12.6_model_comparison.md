...
| Mistral | Mistral | Medium 3.5（128B，Apache 2.0） | 2026-05 |
| xAI | Grok | 3 | 2025-01 |

注：本对比重点关注 Claude、GPT-5、Gemini 3.1 Pro 等主流商业 LLM。OpenAI 于 2026-04-23 发布 GPT-5.5（API 定价 $5/$30 per M tokens），其在 Terminal-Bench 2.0 上达到 82.7%、OSWorld-Verified 78.7%、Expert-SWE 73.1%、GDPval 84.9%。Mistral 于 2026-05 发布 Medium 3.5（128B 参数，256K 上下文，Apache 2.0 开放权重），在 SWE-Bench Verified 上达到 77.6%。后续详细对比仍以 GPT-5.4 为主要参照，GPT-5.5 和 Mistral Medium 3.5 的基准数据会持续补充。
