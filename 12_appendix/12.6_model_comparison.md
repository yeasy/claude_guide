...
注：本对比重点关注 Claude、GPT-5、Gemini 3.1 Pro 等主流商业 LLM。OpenAI 于 2026-04-23 发布 GPT-5.5（API 定价 $5/$30 per M tokens；API 已于 2026-04-24 上线），因公开基准数据有限，后续详细对比仍以 GPT-5.4 为主要参照。
