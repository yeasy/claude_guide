...
| 维度 | Claude Haiku 4.5 | Claude Sonnet 4.6 | Claude Opus 4.6 | GPT-5.4 | Gemini 3.1 Pro | DeepSeek-V3 |
|-----|-----------------|-----------------|-----------------|-------------|---------------|------------|
...
| **性价比指数** | 10.0 | 8.5 | 6.0 | 8.8 | 9.0 | 11.0 |
| **推理能力(MATH)** | 71% | 89% | 95% | 92% | 89% | 90% |
| **编程能力(HE)** | 77% | 92% | 96% | 94% | 93% | 88% |
...
| 维度 | Claude Sonnet 4.6 | GPT-5.4 | Gemini 3.1 Pro |
|-----|-----------|-----------|--------------|
| 知识截止日期 | Sonnet 4.6: 2025-08 | 2026-01 | 以官方模型页为准 |
| 实时网络搜索 | 通过工具 | 通过工具/API | 原生支持 |
| 幻觉率 | 1.3% | 1.1% | 1.6% |
| 事实准确率 | 94.7% | 95.4% | 93.8% |
...
| 攻击类型 | Claude 4.6 防御 | GPT-5.4 防御 | Gemini 3.1 防御 |
|---------|---------------|-----------|--------------|
| 越狱提示 | 很强 | 很强 | 强 |
| 有害内容生成 | 拒绝率 98% | 98% | 96% |
| 隐私敏感信息 | 很强 | 很强 | 强 |
...
| GPT-5.4 mini | $0.0024 | $2.40 | 极低 |
| GPT-5.4 | $0.0060 | $6.00 | 低-中 |
...
graph TD
    ...
    B2["只需图像<br/>→ Claude 4.6 或 GPT-5.4"]
    B3["不需要<br/>→ 继续"]
...
├─ vs GPT-5.4 ($2/M, 95%): Gemini 更便宜性能更好 → 都在前沿上 ✓
