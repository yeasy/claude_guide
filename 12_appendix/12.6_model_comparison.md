...
| **上下文长度** | 200K token | 1M (Beta) | 1M (Beta) | 128K token | 2M token | 64K token |
...
| 编程语言 | Claude 4.6 | GPT-4 Turbo | Gemini 3.1 |
|---------|-----------|-----------|-----------|
| Python | 95% | 92% | 90% |
...
| 特性 | Claude 4.6 | GPT-4 Turbo | Gemini 3.1 |
|-----|-----------|-----------|-----------|
| 正确性 | 92% | 88% | 85% |
| 可运行性 | 95% | 91% | 87% |
| 最佳实践 | 89% | 86% | 82% |
...
| 能力 | Claude 4.6 | GPT-4o | Gemini 3.1 Pro |
|-----|-----------|--------|---------------|
| 物体识别 | 96% | 95% | 94% |
| 文字识别 (OCR) | 94% | 93% | 92% |
| 图表理解 | 91% | 89% | 87% |
...
| 维度 | Claude 4.6 | GPT-4 Turbo | Gemini 3.1 Pro |
|-----|-----------|-----------|--------------|
...
| Gemini 3.1 Pro | $2/M | $8/M | N/A | N/A | 低 |
...
4. **多模态优先 Gemini 3.1 Pro**：视频支持，2M 上下文窗口，成本低，性能优秀
5. **混合策略最优**：
   - 高频日常任务用 Haiku（70% 流量）
   - 关键任务用 Sonnet（25% 流量）
   - 超高精度用 Opus 4.6（5% 流量）
