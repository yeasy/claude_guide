...
> **关于当前口径**：Fable 5 已于 2026-07-01 恢复全球访问，Mythos 5 仍只面向部分美国机构。新项目先评测 Sonnet 5（`claude-sonnet-5`）；Sonnet 4.6 只作为既有系统灰度迁移与回退基线。下方历史对比表不是生产路由，实际采购必须回到官方模型/价格页和自己的评测集。
