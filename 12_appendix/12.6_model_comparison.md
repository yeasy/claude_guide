...
> **关于 Claude 顶配模型口径**：1.1 节表格列出 Fable 5 与 Claude 当前主力三档（Opus 4.8 / Sonnet 4.6 / Haiku 4.5）。其中 2026-06-09 发布的 **Claude Fable 5**（$10/$50、1M 上下文、128K 输出，能力最强的广泛发布模型）为更高一档的新模型；但 2026-06-12 起访问暂停，尚未纳入本附录的生产选型矩阵。本章后续的对比表、决策树与 Pareto 分析仍以 **Opus 4.7** 的具体数字代表 Claude Opus 线的能力与成本——因为 Opus 4.8 沿用 4.7 的 $5/$25 定价与 1M 上下文，能力为 4.7 的超集，故这些数字同样适用于 Opus 4.8。选型时可直接将下文“Opus 4.7”理解为“Opus 线（当前 Opus 档旗舰为 4.8）”。
