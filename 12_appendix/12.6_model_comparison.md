...
| 维度 | Claude Haiku 4.5 | Claude Sonnet 4.6 | Claude Opus 4.6 | GPT-4 Turbo | Gemini 2.5 Pro | DeepSeek-V3 |
|-----|-----------------|-----------------|-----------------|-------------|---------------|------------|
...
|-----|--------|--------|--------|--------|
| Claude Haiku 4.5 | $0.80/M | $4/M | $0.24/M | 最低 |
| Claude Sonnet 4.6 | $3/M | $15/M | $0.90/M | 低 |
...
需求 1: 推理复杂度
  ...
  │  └─ Claude Opus 4.6 ✓
  ├─ 高 (数据分析、架构设计)
  │  └─ Claude Sonnet 4.6 或 GPT-4 Turbo
  └─ 中等及以下
     └─ Claude Haiku 4.5 或 Gemini 2.5 Pro
