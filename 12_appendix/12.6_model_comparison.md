...
| OpenAI | GPT | GPT-5.4（GPT-5 于 2025-08 首发） | 2026-03 |
| Google | Gemini | 3.1 Pro | 2026-02 |
| Meta | Llama | 4 Scout / 4 Maverick | 2025-04 |
| Mistral | Mistral | Large 2 | 2024-09 |
| xAI | Grok | 3 | 2025-01 |

注：本对比重点关注 Claude、GPT-5、Gemini 3.1 Pro 等主流商业 LLM（第一节最新版本表反映各厂商最新发布，后续详细对比基于已有基准数据的 Gemini 3.1 Pro）。
...
| 维度 | Claude Haiku 4.5 | Claude Sonnet 4.6 | Claude Opus 4.6 | GPT-4 Turbo | Gemini 3.1 Pro | DeepSeek-V3 |
|-----|-----------------|-----------------|-----------------|-------------|---------------|------------|
| **定价（输入/输出）** | $1.00/$5.00 | $3.00/$15.00 | $5.00/$25.00 | $10.00/$30.00 | $2.00/$12.00 (<200K 输入档) | $0.27/$1.10 |
| **上下文长度** | 200K token | 1M token | 1M token | 128K token | 1M token | 64K token |
| **推理延迟** | ~100ms | ~300-400ms | ~1-2s | ~200-400ms | ~150-300ms | ~200-300ms |
| **性价比指数** | 10.0 | 8.5 | 6.0 | 3.5 | 9.0 | 11.0 |
| **推理能力(MATH)** | 71% | 89% | 95% | 86% | 89% | 90% |
| **编程能力(HE)** | 77% | 92% | 96% | 90% | 93% | 88% |
| **常识理解(MMLU)** | 82% | 95% | 98% | 94% | 96% | 92% |
...
| 基准 | Claude Sonnet 4.6 | GPT-4 Turbo | Gemini 3.1 Pro | 说明 |
|-----|-----------|-----------|--------------|-----|
| MATH | 89.2% | 86.4% | 89.1% | 数学问题求解 |
| MMLU | 95.1% | 94.1% | 95.9% | 多任务知识理解 |
| HumanEval | 92.3% | 90.2% | 93.0% | 编程能力 |
| ARC-Challenge | 94.2% | 92.8% | 94.5% | 科学推理 |
| HellaSwag | 96.1% | 95.3% | 96.2% | 常识推理 |

**核心观察**

Claude Sonnet 4.6 在数学和编程上略占优势，这归功于：
...
| 编程语言 | Claude Sonnet 4.6 | GPT-4 Turbo | Gemini 3.1 |
|---------|-----------|-----------|-----------|
| Python | 95% | 92% | 90% |
...
| 特性 | Claude Sonnet 4.6 | GPT-4 Turbo | Gemini 3.1 |
|-----|-----------|-----------|-----------|
| 正确性 | 92% | 88% | 85% |
| 可运行性 | 95% | 91% | 87% |
| 最佳实践 | 89% | 86% | 82% |
...
| 能力 | Claude Sonnet 4.6 | GPT-4o | Gemini 3.1 Pro |
|-----|-----------|--------|---------------|
| 物体识别 | 96% | 95% | 94% |
| 文字识别 (OCR) | 94% | 93% | 92% |
| 图表理解 | 91% | 89% | 87% |
...
| 能力 | Claude Sonnet 4.6 | GPT-4o | Gemini 3.1 Pro |
|-----|-----------|--------|---------------|
| 视频摘要 | 可通过图像序列/片段工作流实现 | 支持较强 | 原生视频理解能力更强 |
| 动作识别 | 适合中短片段分析 | 适合中短片段分析 | 对长视频更有优势 |
| 时序理解 | 依赖工作流设计 | 较强 | 更强 |
| 音频转录 | 通常需外部链路 | 视产品形态而定 | 视产品形态而定 |

### 2.4 知识与时效性

| 维度 | Claude Sonnet 4.6 | GPT-4 Turbo | Gemini 3.1 Pro |
|-----|-----------|-----------|--------------|
| 知识截止日期 | Sonnet 4.6: 2025-08 | 2024-04 | 以官方模型页为准 |
| 实时网络搜索 | 通过工具 | 通过工具/API | 原生支持 |
| 幻觉率 | 1.3% | 1.8% | 1.6% |
...
| 攻击类型 | Claude 4.6 防御 | GPT-4 防御 | Gemini 3.1 防御 |
|---------|---------------|-----------|--------------|
| 越狱提示 | 很强 | 强 | 强 |
| 有害内容生成 | 拒绝率 98% | 97% | 96% |
| 隐私敏感信息 | 很强 | 强 | 强 |
...
推荐：**Claude 4.6 + Adaptive Thinking**
...
推荐：**Claude Sonnet 4.6** 或 **GPT-4 Turbo**

| 对比维度 | Claude Sonnet 4.6 | GPT-4 Turbo |
|---------|-----------|-----------|
| 数学推理 | 89.2% | 86.4% |
| 论文理解 | 优秀 | 优秀 |
| 知识截止 | 2025-08 | 2024-04 |
| 幻觉率 | 1.3% | 1.8% |
...
graph TD
    ...
    C["性能等级 95: Sonnet 4.6, GPT-5, Gemini 3.1 Pro<br/>(Pareto 前沿)"]
...
| **Gemini 3.1 Pro** | $2.00 | 95 | 多模态优先 | 右下角（成本优化） |

**不在 Pareto 前沿上的模型**（更好的替代品存在）：

- GPT-5.4 ($2.50/M, 95%): 被 Opus ($5/M, 98%) 在成本和性能上双重击败 ✗
...
Gemini 3.1:   ($2 × 500 + $8 × 200) / 1M = $0.0021
```
