...
| **GPT-5.4** | $2.50 | 94 | 编程与推理、知识时效 | 中偏左 |
...
├─ vs GPT-5.4 ($2.50/M, 94%): GPT-5.4 稍便宜且性能略高 → Sonnet 被支配 ✗
└─ vs Gemini 3.1 Pro ($2/M, 95%): Gemini 更便宜且性能更高 → Sonnet 被支配 ✗

严格 2D Pareto 分析：Sonnet 4.6 不在前沿上（被 GPT-5.4 和 Gemini 3.1 Pro 支配）。
