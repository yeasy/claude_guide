...
> **关于 Claude 顶配模型口径**：上表（1.1 节）将 Claude Opus 4.8（2026-05 发布）列为当前最新旗舰。本章后续的对比表、决策树与 Pareto 分析仍以 **Opus 4.7** 的具体数字代表 Claude Opus 线的能力与成本上限——因为 Opus 4.8 沿用 4.7 的 $5/$25 定价与 1M 上下文，能力为 4.7 的超集，故这些数字同样适用于 Opus 4.8。选型时可直接将下文“Opus 4.7”理解为“Opus 线（当前旗舰为 4.8）”。
...
| 厂商 | 模型系列 | 当前最新版本 | 发布时间 |
|-----|--------|-----------|--------|
| Anthropic | Claude | Opus 4.8 / Sonnet 4.6 / Haiku 4.5 | 2026-05 |
