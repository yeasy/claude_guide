...
#### Q: Claude Sonnet 5 和 Opus 到底该选谁？

**A**:
*   90% 的场景：**选 Sonnet**。它比 Opus 档（当前为 Opus 5）输出速度快约 2 倍、价格约为 Opus 的 40%（Sonnet 5 $2/$10 对 Opus 5 $5/$25），速度-质量平衡最好（“Sonnet 编程更强”是 Sonnet 4.5 对比 Opus 4.1 时代的旧结论——自 Opus 4.7/4.8 起，Opus 档在编程基准上重回领先）。
