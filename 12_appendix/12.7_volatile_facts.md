...
> Last verified: 2026-06-09. 本表是 Claude 模型、API、价格、隐私与竞品对比的更新入口。

| 类别 | 当前维护口径 | 权威入口 | 编辑要求 |
| --- | --- | --- | --- |
| Claude 模型 | Claude Fable 5（2026-06-09 GA，$10/$50、1M、128K 输出）与 Opus / Sonnet / Haiku 各档的模型 ID、上下文、thinking、生命周期以官方模型页为准；Mythos 5 仅限 Glasswing 受邀。 | [Claude Models](https://platform.claude.com/docs/en/about-claude/models/overview) | 不把 dateless model ID 写成 evergreen alias；“最强模型”表述须区分 Fable 5（全系）与 Opus 4.8（Opus 档）。 |
