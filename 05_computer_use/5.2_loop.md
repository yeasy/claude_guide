...
近期 Claude Opus 4.8/4.7/4.6、Claude Sonnet 4.6 和 Claude Opus 4.5 的 Computer Use 组合通常是 `computer-use-2025-11-24` / `computer_20251124`，并配合 `text_editor_20250728` 与 `bash_20250124`；旧 Claude 4 / 3.7 文档曾使用 `computer-use-2025-01-24` / `computer_20250124`。版本会随模型更新，不能写死成永久规则。
