...
|-----|--------|--------------|
| 最大对话长度 | 200K token (~50K 中文字符) | 无限 (M+ token) |
...
4. 未解决的问题"""
    ...
    def get_relevant_context(self, current_query: str, max_tokens: int = 150000) -> list:
        """获取与当前查询相关的上下文消息"""
    ...
    def _calculate_cost(self, response) -> float:
        ...
        try:
            if self.model not in self.prices:
                ...
                prices = self.prices["claude-sonnet-4-5-20250929"]
            else:
