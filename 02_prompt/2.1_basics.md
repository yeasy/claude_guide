...
**长上下文处理**：Opus 4.8、Opus 4.7、Opus 4.6 和 Sonnet 4.6 支持 1M Token 上下文窗口；Fable 5 发布规格同为 1M（曾于 2026-06-12 短暂暂停访问，截至 2026-07-09 已恢复），接入前需核验当前可用性。Haiku 4.5 支持 200K Token，使其能处理更多背景信息而不丢失精准度。
