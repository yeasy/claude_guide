...
> **兼容性提示**：Prefill 在 Claude Opus 4.7、Opus 4.6 和 Sonnet 4.6 上**不受支持**，使用时会返回 400 错误。对于这些新模型，请使用 Structured Outputs（见 2.6.3 节）或系统提示词来控制输出格式。以下内容适用于 Claude Sonnet 4.5 及更早版本。
