...
Cursor 是目前与 Claude 结合最紧密的 IDE。它默认支持 Claude 4.6 Sonnet，并围绕它构建了许多原生体验。

![Cursor IDE 界面](../_images/cursor_interface.jpg)
...
*   **多模型切换**: 可以在 Claude 4.6 Sonnet 和 DeepSeek Coder 之间随意切换。
