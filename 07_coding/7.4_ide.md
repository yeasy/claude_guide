...
虽然 CLI 很酷，但很多开发任务仍发生在 IDE 中。
将 Claude Code 集成到 VS Code、Cursor、JetBrains 或终端编辑器中，可以把文件选择、diff 审阅、计划确认和会话历史放回日常开发界面。
...
*   **多模型切换**: 可以在 Claude Sonnet 4.6 和 DeepSeek Coder 之间随意切换。
