...
*   **2026.06–07**: **2026-06-09 Claude Fable 5 正式 GA**（$10/$50、1M 上下文、128K 输出、Adaptive Thinking 常开），Claude Mythos 5 同日面向 Project Glasswing 受邀客户开放；两者于 6 月 12 日暂停访问后，Fable 5 于 7 月 1 日恢复全球访问，Mythos 5 仅恢复给部分美国机构。Claude Sonnet 5 同期发布，带来新的 tokenizer、默认 Adaptive Thinking 和迁移约束。生产选型仍应回到官方模型页确认当前可用型号和平台范围。
