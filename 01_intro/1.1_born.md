...
*   **2025.05**: Claude Opus 4 与 Sonnet 4 发布；Claude Code 正式 GA。Opus 4 被评为 Level 3 模型。
...
*   **2026.05**: Claude Managed Agents 持续迭代（2026-05-07 新增三项功能，2026-05-19 新增隐私与安全特性）；**2026-05-28 Claude Opus 4.8 发布**，成为当前最强的通用可用模型（沿用 4.7 的 $5/$25 定价、1M 上下文、128K 输出），并为 Claude Code 带来 Dynamic Workflows（研究预览）。
