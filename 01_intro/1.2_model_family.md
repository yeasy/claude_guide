...
*   **Claude Fable 5 (2026.06)**: 2026-06-09 正式 GA，是 Anthropic 能力最强的广泛发布模型，顶层命名不再沿用 Opus/Sonnet/Haiku 体系。定价 $10/$50，1M 上下文、128K 最大输出，Adaptive Thinking 常开（不支持手动 Extended Thinking），模型 ID 为 `claude-fable-5`。同日发布的 **Claude Mythos 5**（`claude-mythos-5`，Mythos Preview 的继任者）仅面向 Project Glasswing 受邀客户提供。详见 [13.1 Claude 4.x 现状与 Claude 5 展望](../13_advanced/13.1_claude5_preview.md)。
