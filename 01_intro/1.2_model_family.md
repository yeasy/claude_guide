...
具体定价细节请参考 **[附录 E：Claude 定价与成本参考](../12_appendix/12.5_pricing.md)** 以及 [官方定价页面](https://claude.com/pricing)。
...
- **Claude Sonnet 5**: **Adaptive Thinking 默认开启**，可显式关闭；手动 Extended Thinking 会返回 400。
