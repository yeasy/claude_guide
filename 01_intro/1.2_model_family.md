...
*   **Claude Fable 5 (2026.06)**: 模型 ID 为 `claude-fable-5`，定价 $10/$50，1M 上下文、128K 最大输出。6 月 12 日暂停后，Fable 5 已于 2026-07-01 恢复全球访问；**Claude Mythos 5**（`claude-mythos-5`）仅恢复给部分美国机构，不能写成全面恢复。生产路由还需显式处理分类器返回的 `stop_reason: "refusal"`。
