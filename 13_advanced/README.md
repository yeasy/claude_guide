...
- **4.8**：Opus 档旗舰（2026-05-28 发布），在 4.7 基础上改进长跨度 Agentic 编码、effort 校准与工具触发
- **5**：已于 2026-06-09 发布——公开 GA 的 **Claude Fable 5**（$10/$50、1M 上下文、128K 输出、Adaptive Thinking 常开）与仅限 Project Glasswing 受邀的 **Claude Mythos 5**；两者曾于 2026-06-12 暂停访问，截至 2026-07-09 已恢复。本章预测性内容写于发布前，保留原文供对照检验（见 13.1）
