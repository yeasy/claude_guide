...
> **与第二章的关系**：第二章介绍的“提示工程”聚焦于单次交互中的措辞和指令优化技巧，是与 Claude 协作的基本功。本章在此基础上进一步拓展：12.1 节帮助你了解最新模型的能力边界与选型策略，12.2 节讲解长对话和大上下文窗口的管理方法，12.3 节则从系统架构视角介绍“上下文工程”——如何动态组织提供给模型的全部信息（RAG、工具输出、对话历史等）。简言之，第二章教你“怎么说”，本章教你“给什么”以及“如何管理”。

这一章分为四个相互关联的部分：

### 12.1 Claude 4.x 现状与 Claude 5 展望
...
### 12.4 模型内部可解释性：Anthropic 的解释性研究进展
...
1. 阅读 12.1 的“重要声明”和“当前主力模型家族”
2. 浏览 12.1.10“模型发布时应优先核对的项目”
3. 了解 12.3 中的“四大策略”框架

### 标准学习（1-2 小时）

1. 完整阅读 12.1，重点关注“知识截止日期与能力边界”“模型发布时应优先核对的项目”“选型建议”
2. 学习 12.2 的“长对话管理策略”部分
3. 深入 12.3 的“上下文工程实践”部分
