...
> 注：Opus 4.8 为当前 Opus 线旗舰，沿用 4.7 的 $5/$25 定价。更高一档的 Claude Fable 5（2026-06-09 GA，$10.00/M 输入、$50.00/M 输出；2026-06-12 起访问暂停）未列入上表，定价与缓存价格见上方“三层+旗舰模型梯队”表及[附录 E：Claude 定价与成本参考](../12_appendix/12.5_pricing.md)。
