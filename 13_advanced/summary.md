...
- **可解释性研究的工程意义**：理解模型内部机制（特征、回路）有助于预判能力边界与失败模式，而不只是“黑盒调参”。
- **Anthropic 的公开工作**：以特征可视化与回路分析为代表的机制可解释性研究持续推进，相关文章与工具以官方发布为准（链接核验见该节文末）。
...
> 注：当前 Opus 线旗舰为 Opus 4.8（2026-05 发布），沿用 4.7 的 $5/$25 定价，上表以 Opus 4.7 数字代表 Opus 线成本。
