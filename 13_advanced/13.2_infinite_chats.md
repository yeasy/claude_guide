...
> 💡 **相关阅读**：本章涉及长对话的上下文管理，与第 12.3 章《Context Engineering》的主题密切相关。建议结合阅读。
...
### 12.2.10 1M Token 窗口的现实

从 2024 年中期开始，Claude 的上下文窗口已升至 200K token。到 Claude 4.6，长上下文能力已扩展到 1M token 档位，但具体是否为 beta / public beta、账号是否可用、200K 以上是否有 long-context pricing，都要按官方模型页和价格页核验；上下文管理的重点也从“能不能塞进去”逐步转向“如何高质量地利用超长上下文”。
