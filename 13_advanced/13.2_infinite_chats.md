...
从 2024 年中期开始，Claude 的上下文窗口已升至 200K token。到 Claude 4.6/4.7/4.8 与 Sonnet 4.6，长上下文能力已扩展到 1M token 档位，但具体是否为 beta / public beta、账号是否可用、是否采用标准 API 定价，都要按官方模型页、迁移指南和价格页核验；上下文管理的重点也从“能不能塞进去”逐步转向“如何高质量地利用超长上下文”。
