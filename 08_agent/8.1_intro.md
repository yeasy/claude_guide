...
这是控制中心。本书专注于 **Claude Sonnet 4.6 / Opus** 作为大脑。
...
*   **Short-term**: 当前的 Context Window（以 Claude 4.6 为例，长上下文能力可达 1M，但具体可用性需看平台和模型档位）。
...
2.  **超长 Context（最高可达 1M）**：Agent 在运行过程中会产生大量的日志和中间状态。Claude 的长上下文能力能够容纳更长的执行历史，减少 “灾难性遗忘”。
