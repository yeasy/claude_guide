...
这是控制中心。本书专注于 **Claude 4.6 Sonnet / Opus** 作为大脑。
...
*   **Short-term**: 当前的 Context Window (1M tokens)。
...
2.  **超长 Context (1M)**：Agent 在运行过程中会产生大量的日志和中间状态。Claude 的超长上下文容量能容纳更长的执行历史，减少 “灾难性遗忘”。
