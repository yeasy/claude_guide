...
graph TD
    User --> Agent
    Agent <--> WorkingMem[🧠 Short-term: Context Window]
    Agent <--> VectorDB[📚 Long-term: Vector Store]
    Agent <--> SQL[🗃️ Structured: SQL/Graph DB]
```
**图 1: Agent 记忆分层架构示意图**
...
#### Semantic Memory (语义记忆/知识库)
*   **介质**: 外部知识文档、结构化数据库。
*   **内容**: 公司的 SOP、产品手册、Fact Facts。

### 8.3.2 突破 Context 限制的技术
