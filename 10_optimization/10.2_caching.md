...
├── 有缓存实际成本：~$1.14（绝大部分 token 以缓存读取价计；此处沿用 Sonnet 4.6 的 $0.30/MTok，Sonnet 5 对应为 $0.20/MTok）
└── 节省：约 81%
```
...
| Opus 5（当前 Opus 档） | $5.00 | $25.00 | $0.50 | $6.25 |
| Opus 4.5 / 4.6 / 4.7 / 4.8（Legacy） | $5.00 | $25.00 | $0.50 | $6.25 |
